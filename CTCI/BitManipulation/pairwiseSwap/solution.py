...
Ok, so like,
if we have a number like: 

10101010

it would convert to something like:
01010101
...
then move one more space

or we could AND with 01010101 for the even and then move all those bits to the left by one
and thendo the same with 10101010 for the odds and move right by one
